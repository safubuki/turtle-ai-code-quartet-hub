...
- VS Code ウィンドウ制御、保存復元、AI 状態表示を再導入しないための責務分担を知りたいとき
- 既知課題と現在の QA 方針を確認しながら、デグレを避けて対応したいとき

## 概要

Turtle AI Code Quartet Hub は、4 つの VS Code ウィンドウを WPF パネルで管理し、2x2 配置、集中表示、裏保存を行う Windows 向けツールです。AI 状態表示や VS Code 外周フレームは削除済みで、現在は軽量なウィンドウ管理に集中しています。
