...
- ウィンドウ配置と復元のために、ローカルのウィンドウタイトルと保存済み設定を参照する。
...
assets/store/desktop-03-focus.png
assets/store/desktop-04-ide-cli.png
```

撮影前チェック:

- ダミーのワークスペースを使う。
- 4面のうち少なくとも1面は AI CLI を表示し、マルチアプリ対応が伝わる構図にする。
